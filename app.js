...
// 9 because 1^2 + 2^2 + 2^2 = 9.

const numPass = [0, 3, 4, 5]

function squareSum(numbers) {
    let squareCount = 0
    for (let i = 0; i < numbers.length; i++) {
        squareCount += numbers[i] ** 2
    }
    return squareCount
}
...
// There are five workers : James,John,Robert,Michael and William.They work one by one and on weekends 
// they rest. Order is same as in the description(James works on mondays,John works on 
// tuesdays and so on).You have to create a function 'task' that will take 3 arguments(w, n, c):
...
// For example:
// task('Monday', 15, 2) -> 'It is Monday today, James, you have to work, you 
// must spray 15 trees and you need 30 dollars to buy liquid'
...
// Create a function, called insurance(), that computes the 
// cost of renting a car. The function takes 3 arguments
// : the age of the renter, the size of the car, and the number 
// days for the rental. The function should return an 
// integer number of the calculated total cost of the rental.

// Age (integer) : There is a daily charge of $10 if the 
// driver is under 25

// Car Size (string) : There may be an additional 
// daily charge based on the car size:
...
// Note: Negative rental days should return 0 cost. Any 
// other car size NOT listed should come with a same 
// surcharge as the "full-size", $15.
...
function insurance(age, size, numofdays) {
    ...
    return (totalAge * numofdays) + (totalSize * numofdays)
